App = {
     ...
     initWeb3: function() {
          ...
          if (typeof web3 !== 'undefined') {
            //reuse the provier of the web3 object injected by the Metamask
          ...
          web3 = new Web3(App.web3Provider);  //this will be a global variable
    ...
    //listen to events triggered by the contracts
...
//
// //retrieve the article template and fill interval it
// var articleTemplate = $('#articleTemplate');
